...
public class JsonServiceTest3 {
 @Autowired
 private TestRestTemplate restTemplate;
 @Test
 public void test() {
	ResponseEntity<List> res=
	this.restTemplate.getForEntity("/api/findTreeManagerInEmployee", List.class);
	...
	Assert.assertEquals(usersMap.get(0).get("managerId").toString(),"0");
