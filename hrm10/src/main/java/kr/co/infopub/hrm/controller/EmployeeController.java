...
/*	http://localhost:8199/humans/api/findAllEmployees
	 ...
	 @RequestMapping(value = "/findAllEmployees", method = RequestMethod.GET,produces = "application/json")
...
http://localhost:8199/humans/api/findAllDepartments
    ...
    @ApiOperation(value = "모든 부서의 정보를 반환한다. 적어도 1명 이상의 사원이 있는 부서만 반환한다.", response = List.class)
	@RequestMapping(value = "/findAllDepartments", method = RequestMethod.GET,produces = "application/json")
...
/*	http://localhost:8199/humans/api/findEmployeesByDepartName/Human Resources
 http://localhost:8199/humans/api/findEmployeesByDepartName/Human%20Resources
	...
	@RequestMapping(value = "/findEmployeesByDepartName/{name}", method = RequestMethod.GET,produces = "application/json")
...
/*	{
	...
	@RequestMapping(value = "/getEmployeesTotal", method = RequestMethod.GET,produces = "application/json")
...
http://localhost:8199/humans/api/findAllDepartments2
   [
	...
	@RequestMapping(value = "/findAllDepartments2", method = RequestMethod.GET,produces = "application/json")
...
/*	http://localhost:8199/humans/api/findAllDepCounts
	...
	@RequestMapping(value = "/findAllDepCounts", method = RequestMethod.GET,produces = "application/json")
...
/*	http://localhost:8199/humans/api/findTreeManagerInEmployee
	...
	@RequestMapping(value = "/findTreeManagerInEmployee", method = RequestMethod.GET,produces = "application/json")
	public ResponseEntity<List<EmployeeDto>> findTreeManagerInEmployee() throws Exception {
...
/*	http://localhost:8199/humans/api/findEmployeesByManagerId/101
	...
	@RequestMapping(value = "/findEmployeesByManagerId/{managerId}", method = RequestMethod.GET,produces = "application/json")
	...
	@RequestMapping(value = "/findEmployeesByEmpId/{employeeId}", method = RequestMethod.GET,produces = "application/json")
...
/*	http://localhost:8199/humans/api/findEmployeeById/101
	...
	@RequestMapping(value = "/findEmployeeById/{employeeId}", method = RequestMethod.GET,produces = "application/json")
...
/*	http://localhost:8199/humans/api/findManagersByName//king
	...
	@RequestMapping(value = "/findManagersByName/{name}", method = RequestMethod.GET,produces = "application/json")
...
/*	http://localhost:8199/humans/api/getTreeMaxLevel
	...
	@RequestMapping(value = "/getTreeMaxLevel", method = RequestMethod.GET,produces = "application/json")
...
/*	http://localhost:8199/humans/api/updateEmployee
	...
	@RequestMapping(value = "/updateJobHistory", method = RequestMethod.POST,produces = "application/json")
	...
	@RequestMapping(value = "/deleteEmployee/{employeeId}", method = RequestMethod.POST,produces = "application/json")
