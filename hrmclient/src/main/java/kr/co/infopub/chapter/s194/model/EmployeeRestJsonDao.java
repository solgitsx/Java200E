...
import kr.co.infopub.chapter.s194.help.BoolResult;
import kr.co.infopub.chapter.s194.help.NumberResult;
public class EmployeeRestJsonDao {
 ...
 // Restful JSON -> List<LinkedHashMap<String, Object>> 
 //              -> List<EmployeeDto>
 public List<EmployeeDto> findAllEmployees() throws SQLException{
    ...
    List<LinkedHashMap<String, Object>> usersMap = 
      restTemplate.getForObject(REST_SERVICE_URI+"/findAllEmployees", 
    		                                           List.class);
 ...
 public List<DepartmentDto> findAllDepartments () throws SQLException{
	...
	RestTemplate restTemplate = new RestTemplate();
    List<LinkedHashMap<String, Object>> usersMap = 
      restTemplate.getForObject(REST_SERVICE_URI+"/findAllDepartments",
    		                                              List.class);
 ...
 public  List<EmployeeDto> findTreeManagerInEmployee () throws SQLException{
	...
	RestTemplate restTemplate = new RestTemplate();
    List<LinkedHashMap<String, Object>> usersMap = 
      restTemplate.getForObject(REST_SERVICE_URI+"/findTreeManagerInEmployee", 
    				                                          List.class);
    List<EmployeeDto> lists=new ArrayList<>();  
    if(usersMap!=null){
        for(LinkedHashMap<String, Object> map : usersMap){
