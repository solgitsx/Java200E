...
public class EmployUpdateFxController {
	    @FXML
...
//	    		alert2.setHeaderText("예외 발생");
//	    		alert2.setContentText(new SQLException("Null Reference Excption ").toString());
//	    		alert2.showAndWait();
	    		return;
	    	}
	    ...
	    void actionDeleteEmployee(ActionEvent event){
	    	...
	    	EmployeeDto edot=EmpConvert.toDto(emp);
	    	try {
				boolean isS=employeeDAO.deleteEmployee(edot);
				if(isS){
